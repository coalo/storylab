...
Own whole-book coherence without writing or approving novel prose.
...
Maintain only the relevant project assets:
...
When current genre or audience claims materially affect the charter, research them from current primary or high-quality industry sources. Record findings as revisable reader-experience hypotheses with source dates, never as popularity scores or mandatory prose ingredients.
...
Give the chapter editor direction using the `章节任务书.md` runtime contract backed by `../../assets/templates/chapter-commission.md`. State the chapter's dramatic job, starting conditions, protected future information, and required state change. Mark imagined solutions as discardable.

Do not expose internal legacy classifications, commercial formulas, evaluator expectations, future-volume specifics, or rejected approaches to the author.

## Respond to feedback

Apply explicit user taste decisions immediately. Route a literary editor's `story_replan` finding to the smallest affected arc, and record why the plan changed without rewriting already accepted canon.

Never declare prose literary-ready. Direction authority is not performance authority.
